# -*- coding: utf-8 -*-
"""network_models_256.ipynb

Automatically generated by Colab.

Original file is located at
    https://colab.research.google.com/drive/14Dbps0n8QvWUWILaDWLRaQK76rNgDWfn
"""

"""
defining all 256 models
Network using pooling layers will mention Ben’s name
bens_maxunpool_256
bens_nn_256
bens_linear_256
bens_transpose_256
...
class bens_cubic(nn.Module):
    def __init__(self, **kwargs):
        ...
        self.unflatten = nn.Unflatten(1,(1,16))
...
class bens_cubic_code(bens_cubic):
...
class bens_cubic_decode(bens_cubic):
    def forward(self, features):
